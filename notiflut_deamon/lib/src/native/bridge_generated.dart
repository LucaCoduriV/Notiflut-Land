...
// Section: api2wire
  ...
  @protected
  ffi.Pointer<wire_DeamonAction> api2wire_box_autoadd_deamon_action(
      DeamonAction raw) {
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_box_autoadd_deamon_action(
      DeamonAction apiObj, ffi.Pointer<wire_DeamonAction> wireObj) {
  ...
  void _api_fill_to_wire_deamon_action(
      DeamonAction apiObj, wire_DeamonAction wireObj) {
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_send_deamon_actionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_DeamonAction>)>>('wire_send_deamon_action');
  late final _wire_send_deamon_action = _wire_send_deamon_actionPtr
      .asFunction<void Function(int, ffi.Pointer<wire_DeamonAction>)>();
  ...
  late final _new_box_autoadd_deamon_action_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_DeamonAction> Function()>>(
          'new_box_autoadd_deamon_action_0');
  late final _new_box_autoadd_deamon_action_0 =
      _new_box_autoadd_deamon_action_0Ptr
          .asFunction<ffi.Pointer<wire_DeamonAction> Function()>();
  ...
  late final _inflate_DeamonAction_ShowPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<DeamonActionKind> Function()>>(
          'inflate_DeamonAction_Show');
  late final _inflate_DeamonAction_Show = _inflate_DeamonAction_ShowPtr
  ...
  late final _inflate_DeamonAction_ClosePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<DeamonActionKind> Function()>>(
          'inflate_DeamonAction_Close');
  late final _inflate_DeamonAction_Close = _inflate_DeamonAction_ClosePtr
      .asFunction<ffi.Pointer<DeamonActionKind> Function()>();
  ...
  late final _inflate_DeamonAction_UpdatePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<DeamonActionKind> Function()>>(
          'inflate_DeamonAction_Update');
