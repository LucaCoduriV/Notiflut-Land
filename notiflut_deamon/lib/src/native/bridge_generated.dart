...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  late final _inflate_DeamonAction_FlutterClosePtr = _lookup<ffi.NativeFunction<ffi.Pointer<DeamonActionKind> Function()>>('inflate_DeamonAction_FlutterClose');
  late final _inflate_DeamonAction_FlutterClose = _inflate_DeamonAction_FlutterClosePtr.asFunction<ffi.Pointer<DeamonActionKind> Function()>();

  ffi.Pointer<DeamonActionKind> inflate_DeamonAction_FlutterActionInvoked() {
    return _inflate_DeamonAction_FlutterActionInvoked();
  }

  late final _inflate_DeamonAction_FlutterActionInvokedPtr = _lookup<ffi.NativeFunction<ffi.Pointer<DeamonActionKind> Function()>>('inflate_DeamonAction_FlutterActionInvoked');
  late final _inflate_DeamonAction_FlutterActionInvoked = _inflate_DeamonAction_FlutterActionInvokedPtr.asFunction<ffi.Pointer<DeamonActionKind> Function()>();

  ffi.Pointer<PictureKind> inflate_Picture_Data() {
    return _inflate_Picture_Data();
  }

  late final _inflate_Picture_DataPtr = _lookup<ffi.NativeFunction<ffi.Pointer<PictureKind> Function()>>('inflate_Picture_Data');
  late final _inflate_Picture_Data = _inflate_Picture_DataPtr.asFunction<ffi.Pointer<PictureKind> Function()>();

  ffi.Pointer<PictureKind> inflate_Picture_Path() {
    return _inflate_Picture_Path();
  }

  late final _inflate_Picture_PathPtr = _lookup<ffi.NativeFunction<ffi.Pointer<PictureKind> Function()>>('inflate_Picture_Path');
  late final _inflate_Picture_Path = _inflate_Picture_PathPtr.asFunction<ffi.Pointer<PictureKind> Function()>();
...
class DeamonActionKind extends ffi.Union {
  ...
  external ffi.Pointer<wire_DeamonAction_FlutterActionInvoked> FlutterActionInvoked;
}
